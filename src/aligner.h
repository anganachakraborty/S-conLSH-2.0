...
public:
	...
	int 			applySV(kseq_t *trunk, Sam_Rec *_svsams, uint32_t L, uint32_t *pat, uint32_t len_genome, int align, int tr);
        int 			align_NonSV(kseq_t *trunk, char *useread, Sam_Rec *_sams, bkt2 *preserved);
	int 			align_SV(kseq_t *trunk, int offset, char *useread,Sam_Rec *_sams,bkt2 *preserved);

	int 			alignFree_NonSV(kseq_t *trunk, char *useread ,Sam_Rec *_sams,bkt2 *preserved);
	int 			alignFree_SV(kseq_t *trunk, int offset, char *useread, Sam_Rec *_sams,bkt2 *preserved);
private:
